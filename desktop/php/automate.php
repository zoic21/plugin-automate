...
sendVarToJS('eqType', 'automate');
$eqLogics = eqLogic::byType('automate');
?>
...
?>
 ...
 <div class="col-lg-10 col-md-9 col-sm-8 eqLogicThumbnailDisplay" style="border-left: solid 1px #EEE; padding-left: 25px;">
  ...
  <legend><i class="fa fa-table"></i> {{Mes automates}}</legend>
  <div class="eqLogicThumbnailContainer">
    <?php
foreach ($eqLogics as $eqLogic) {
	...
	echo '<img src="plugins/automate/doc/images/automate_icon.png" height="105" width="95" />';
	echo "<br>";
...
<div class="col-lg-10 col-md-9 col-sm-8 eqLogic" style="border-left: solid 1px #EEE; padding-left: 25px;display: none;">
  ...
  <ul class="nav nav-tabs" role="tablist">
   ...
   <li role="presentation"><a href="#flowtab" aria-controls="home" role="tab" data-toggle="tab"><i class="fa fa-film"></i> {{Flow}}</a></li>
    ...
    <form class="form-horizontal">
      <fieldset>
        <div class="form-group">
          <label class="col-sm-3 control-label">{{Nom de l'équipement automate}}</label>
          <div class="col-sm-3">
            <input type="text" class="eqLogicAttr form-control" data-l1key="id" style="display : none;" />
            <input type="text" class="eqLogicAttr form-control" data-l1key="name" placeholder="{{Nom de l'équipement automate}}"/>
          </div>
        </div>
        <div class="form-group">
...
<div role="tabpanel" class="tab-pane" id="flowtab">
 <br/>
 <form class="form-horizontal">
  <fieldset>
    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
      <?php
$groups = array();
foreach (automate::flowParameters() as $key => $info) {
...
foreach ($groups as $group) {
	...
	foreach ($group as $key => $info) {
		...
		if (isset($info['configuration']) && count($info['configuration']) > 0) {
			echo '<a class="btn btn-warning configureflow" data-flow="' . $info['key'] . '"><i class="fa fa-cog" aria-hidden="true"></i> {{Configurer}}</a>';
		}
		echo '</div>';
		echo '<div class="col-sm-2">';
		echo ' <a class="btn btn-success downloadflow" data-flow="' . $info['key'] . '"><i class="fa fa-download" aria-hidden="true"></i> {{Télécharger}}</a>';
		echo '</div>';
...
<?php include_file('desktop', 'automate', 'js', 'automate');?>
